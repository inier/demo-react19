...
async function allowMethod() {
  await get('/api-mock/only-get-method')
  await post('/api-mock/only-get-method')
...
async function dynamicMatchUrl() {
  await get('/api-mock/author/10001')
  await get('/api-mock/author/10002')
  await get('/api-mock/author/10003')
}
